...
--DELETE SIMPLES 
DELETE Devedores WHERE ClienteCodigo = 'L-50'
GO
--DELETE COMPOSTO
DELETE Devedores 

FROM dbo.Devedores INNER JOIN CLIENTES ON Clientes.ClienteCodigo = Devedores.ClienteCodigo

WHERE dbo.Clientes.ClienteCodigo = 'L-50'
GO

--update simples
UPDATE dbo.Contas SET ContaSaldo = 801.00 WHERE ContaNumero = 'C-101'

--update composto
UPDATE dbo.Contas SET ContaSaldo = 801.00 
FROM dbo.Contas INNER JOIN dbo.Clientes ON Clientes.ClienteCodigo = Contas.ClienteCodigo
WHERE Clientes.ClienteCodigo = '11'

--ALTER TABLE ALTER COLUMN
ALTER TABLE dbo.Clientes ALTER COLUMN ClienteNome VARCHAR(51)

--ALTER TABLE ADD/REMOVE COLUMN
ALTER TABLE dbo.Clientes ADD Idade INT

ALTER TABLE dbo.Clientes DROP COLUMN Idade
